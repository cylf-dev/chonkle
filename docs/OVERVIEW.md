...
This document covers why chonkle uses Wasm, why the host is written in Python, and how the three codec backends fit together. For general Wasm background, see the [knowledge base](wasm/). For normative specs, see [reference/](reference/).
